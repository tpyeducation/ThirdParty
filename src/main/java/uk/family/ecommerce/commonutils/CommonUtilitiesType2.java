...
public class CommonUtilitiesType2 {
    ...
    public static int getNoOfVowels(String input) {
    ...
    public static int getNoOfConsonents(String input) {
        input = input.toLowerCase();
        int count = 0;
        for (int i = 0; i < input.length(); i++) {
            // check if char[i] is vowel
    ...
    public static int getHowManyDaysOldIam(String inputDateStr) {
        try {
    ...
    public static String getCharAt(String input, int position) {
        return String.valueOf(input.charAt(position));
    }

    public static String getAppendedString(String input1, String  input2, String  input3, String  input4, String  input5,
                                    String seperatedBy) {
        return input1 + seperatedBy + input2 + seperatedBy + input3 + seperatedBy + input4 + seperatedBy + input5;
    }

    public static int getStringLengthxx(String input, int i, int j, String pp) {
        return 5;
    }
